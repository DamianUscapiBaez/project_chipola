...
export const DespachoPdf = ({ yearpdf, data, searchDespacho, mesesDelAnio }) => {
    ...
    return (
        <Document>
            {
                searchDespacho.mescosecha === 0 &&
                <Page style={styles.body} orientation="portrait" size={{ width: '8.5in', height: '11in' }}>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        <View style={{ display: 'flex', flexDirection: 'row', color: '#fff', backgroundColor: "#2a8038", paddingTop: "5px", paddingBottom: '5px' }}>
                            ...
                            <View style={{ display: 2, width: '100px', margin: '2px' }}>
                                <Text style={{ fontSize: '7.5px' }}>MES</Text>
                            </View>
                            ...
                            <View style={{ display: 4, width: '70px', margin: '2px' }}>
                                <Text style={{ fontSize: '7.5px', textAlign: 'right' }}>TOTAL VENTA</Text>
                            </View>
                        ...
                        </View>
                        {
                            data.map((r, index) => (
                                <View key={index} style={{ display: 'flex', flexDirection: 'row', backgroundColor: '#EBF8FF', padding: estilosTablaPdf.padding }}>
                                    ...
                                    <View style={{ display: 2, width: '100px', margin: '2px' }}>
                                        <Text style={{ fontSize: '8pt' }}>{r.mes.toUpperCase()}</Text>
                                    </View>
                                    <View style={{ display: 3, width: '70px', margin: '2px' }}>
                                        <Text style={{ fontSize: '8pt', textAlign: 'right' }}>{r.total_cosecha}</Text>
                                    </View>
                                    <View style={{ display: 4, width: '70px', margin: '2px' }}>
                                        <Text style={{ fontSize: '8pt', textAlign: 'right' }}>{r.despacho_dia}</Text>
                                    </View>
                                    <View style={{ display: 5, width: '10px', margin: '2px' }}>
                                        <Text style={{ fontSize: '7.5px' }}></Text>
                                    </View>
                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', color: '#fff', backgroundColor: "#2a8038", padding: "4px 0" }} fixed>
                            ...
                            <View style={{ display: 3, width: '70px', margin: '2px' }}>
                                <Text style={{ fontSize: '7.5px', textAlign: 'right' }}>{data.reduce((total, item) => parseFloat(total) + parseFloat(item.total_cosecha), 0).toFixed(2)}</Text>
                            </View>
                            <View style={{ display: 4, width: '70px', margin: '2px' }}>
                                <Text style={{ fontSize: '7.5px', textAlign: 'right' }}>{data.reduce((total, item) => parseFloat(total) + parseFloat(item.despacho_dia), 0).toFixed(2)}</Text>
                            </View>
                            <View style={{ display: 16, width: '10px', margin: '2px' }}>
                                <Text style={{ fontSize: '7.5px' }}></Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} fixed>
                        ...
                        <View style={{ marginLeft: 'auto' }}>
                            <Text style={{ fontSize: '16px' }}>
                                REPORTE DE COSECHAS DEL MES {mesesDelAnio[searchDespacho.mescosecha].nombre}
                            </Text>
                        </View>
                    </View>
